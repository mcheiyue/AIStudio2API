...
const zhCN = {
  ...
  'common.unknown': '未知',
  'accounts.empty': '暂无账户',
  'accounts.emptyHint': '添加账户后即可开始登录',
  'accounts.label': 'Google 邮箱',
  'accounts.proxy': '账户代理',
  'accounts.locale': '语言区域',
  'accounts.timezone': '时区',
  'accounts.models': '模型',
'accounts.mode': '传输模式',
'accounts.modePlayground': 'Playground（默认）',
'accounts.modeBuildapp': 'Build App',
'accounts.buildAppUrl': 'Build App 地址',
'accounts.buildAppUrlPlaceholder': 'https://aistudio.google.com/apps/...',
'accounts.buildAppHint': 'fork 自默认 applet 的本账号自有 app 实例地址',
  'accounts.benefitTier': '账户权益',
  'accounts.direct': '直连',
  'accounts.addTitle': '添加账户',
  'accounts.startLogin': '隔离 Camoufox 登录',
...
const en: Record<TranslationKey, string> = {
  ...
  'accounts.emptyHint': 'Add an account to start the login flow',
  'accounts.label': 'Google email',
  'accounts.proxy': 'Account proxy',
  'accounts.locale': 'Locale',
  'accounts.timezone': 'Timezone',
  'accounts.models': 'Models',
'accounts.mode': 'Transport mode',
'accounts.modePlayground': 'Playground (default)',
'accounts.modeBuildapp': 'Build App',
'accounts.buildAppUrl': 'Build App URL',
'accounts.buildAppUrlPlaceholder': 'https://aistudio.google.com/apps/...',
'accounts.buildAppHint': 'Your own forked app instance URL (not the default applet)',
  'accounts.benefitTier': 'Account tier',
  'accounts.direct': 'Direct',
  'accounts.addTitle': 'Add account',
  'accounts.startLogin': 'Isolated Camoufox login',
...
const legacyKeyMap: Partial<Record<TranslationKey, string>> = {
  ...
  'accounts.startLogin': 'account.startLogin',
